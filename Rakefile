...
Jeweler::Tasks.new do |gem|
  ...
  gem.name = "jeweler-ghpages-test-1"
  gem.summary = %Q{Ghpages test}
  gem.description = %Q{Testing ghpages for jeweler 1.5}
  gem.email = "dreamcat4@gmail.com"
  gem.homepage = "http://github.com/dreamcat4/jeweler-ghpages-test-1"
